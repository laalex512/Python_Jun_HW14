...
def test_normal_year():
    assert input_date('05.12.1983') == True


def test_max_year():
    assert input_date('01.01.10000') == False


def test_max_days():
    assert input_date('32.01.2000') == False


def test_leap_year400():
    assert input_date('29.02.2000') == True


def test_not_leap_year():
    assert input_date('29.02.2001') == False


def test_normal_leap_year():
    assert input_date('29.02.1984') == True
